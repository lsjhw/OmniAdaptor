...
public class FlinkStateDeserializerTest {
    ...
    void testDeserializeLocalStateSnapshot() throws Exception {
        ...
        TaskStateSnapshot snapshot = TaskStateSnapshotDeser.deserializeTaskStateSnapshot(localStateJson, null);
    ...
    void testDeserializeRemoteStateSnapshot() throws Exception {
        ...
        TaskStateSnapshot snapshot = TaskStateSnapshotDeser.deserializeTaskStateSnapshot(remoteStateJson, null);
        assertNotNull(snapshot);
        assertFalse(snapshot.isTaskFinished());
